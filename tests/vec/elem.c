...
QC_MKTEST(qc_vec_elem_len_test,
        prop2,
        qc_vec_elem_len_prop,
        &qc_vec_info,
        &qc_int_info
        );

QC_MKTEST(qc_vec_elem_elem_test,
        prop2,
        qc_vec_elem_elem_prop,
        &qc_vec_info,
        &qc_int_info
        );

QC_MKTEST(qc_vec_elem_content_test,
        prop2,
        qc_vec_elem_content_prop,
        &qc_vec_info,
        &qc_int_info
        );

QC_MKTEST(qc_vec_elem_iter_test,
        prop2,
        qc_vec_elem_iter_prop,
        &qc_vec_info,
        &qc_int_info
        );
