...
VEC_STATIC bool                  VEC_ITERING        (const struct VEC_VEC * self);
VEC_STATIC bool                  VEC_ITER_END       (struct VEC_VEC * self);
...
VEC_STATIC size_t                VEC_ITER_IDX       (struct VEC_VEC * self);
